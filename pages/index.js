    ...
    <>
      <div className="home-container">
        ...
        <div className="home-hero">
          ...
          <div className="home-container3">
            ...
            <span className="home-text03">
              esse curso é recomendado  para vendas online
            </span>
            <div className="home-btn-group1">
              <button className="home-button1 button">Começar Gratis </button>
              <button className="home-button2 button">introdução</button>
            </div>
          </div>
        </div>
        ...
        <footer className="home-footer">
            ...
            <div className="home-links-container">
              <div className="home-container5">
                <div className="home-product-container">
                  ...
                  <span className="home-text08">Tutorials</span>
                  <span>Curso</span>
                </div>
                <div className="home-company-container">
                  <span className="home-text10">Empresa</span>
                  <span className="home-text11">Sobre</span>
                  <span className="home-text12">seja parceiro</span>
                  <span className="home-text13">Contato</span>
                </div>
              </div>
              <div className="home-container6">
                <div className="home-contact">
                  <span className="home-text14">Nosso contato</span>
                  <span className="home-text15">contato@foto10x.site</span>
                  <span>(11) 967272695</span>
                </div>
                <div className="home-socials">
                  <span className="home-text17">Segue nós</span>
          ...
          <span className="home-text18">© 2023 By startpee FOTO10X</span>
        </footer>
      </div>
      <style jsx>
        {`
