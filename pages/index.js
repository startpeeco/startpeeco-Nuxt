        ...
        <div className="home-hero">
          ...
          <div className="home-container4">
            <h1 className="home-text">
              ...
              <span className="home-text02">que</span>
              <span className="home-text03"> chama atenção</span>
            </h1>
            <span className="home-text04">
              destaque-se nas  plataformas de vendas e aumente suas vendas 
            </span>
        ...
        <footer className="home-footer">
          <div className="home-container5">
            <div className="home-logo">
              ...
              />
              <span className="home-text05">excelência  sempre</span>
            </div>
            <div className="home-links-container">
              <div className="home-container6">
                <div className="home-product-container">
                  <span className="home-text06">Produto</span>
                  <span className="home-text07">Loja</span>
                  <span className="home-text08">Serviços</span>
                </div>
                <div className="home-company-container">
                  <span className="home-text09">Empresa</span>
                  <span className="home-text10">Sobre</span>
                  <span className="home-text11">seja parceiro</span>
                </div>
              </div>
          ...
          <span className="home-text14">© 2023 By startpee FOTO10X</span>
        </footer>
      </div>
      <style jsx>
        {`
